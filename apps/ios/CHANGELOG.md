...
- Recovered cleanly from revoked Iànua sessions: Chat now returns to login, SIP reports that access is required, and Realtime rejects stale private endpoint overrides instead of showing unrelated configuration errors.
