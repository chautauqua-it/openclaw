  ...
  private fun ensureChannel(priority: String?): String {
    ...
    val (suffix, importance, name) =
      when (normalizedPriority) {
        "passive" -> Triple("passive", NotificationManager.IMPORTANCE_LOW, "Iànua Passive")
        "timesensitive" -> Triple("timesensitive", NotificationManager.IMPORTANCE_HIGH, "Iànua Time Sensitive")
        else -> Triple("active", NotificationManager.IMPORTANCE_DEFAULT, "Iànua Active")
      }
